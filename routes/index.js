...
//         if(fileExt.indexOf(".json")===0){
//         let rsjson = JSON.parse(JSON.stringify(files));
//         let path = rsjson.avatar.path;
//         let obj = xlsx.parse(path);
//         let excelObj  = obj[0].data;
//         var date = JSON.stringify(excelObj)
//         var decipher = crypto.createDecipher("rc4", "MY SECRET KEY");
//         var decrypted = decipher.update(date, "utf8", "hex");
//         decrypted += decipher.final("hex");
//         writeFile(rsjson.avatar.name+".json",JSON.stringify(decrypted));
